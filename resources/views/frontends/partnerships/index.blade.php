...
@section('content')
    ...
    <div class="m-0 p-0 h-screen overflow-x-hidden scroll-smooth">
        ...
        <div class="relative h-full w-full">
            ...
            {{-- content --}}
            <div class="relative z-10 mt-[5rem] md:mt-[13rem] pb-[20rem]">
                <div class="w-full max-w-screen-xl mx-auto px-3 md:px-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-7 rounded-sm">
                        <div class="w-full h-full">
                            <h1 data-aos="fade-down" class="text-[32px] md:text-[50px] lg:text-[60px] font-bold whitespace-pre-line leading-[32px] md:leading-[60px]
                            {{session()->get('locale') === 'en' ? "text-[32px] md:text-[32px] lg:text-[60px]  leading-[32px] md:leading-[60px] font-['Inter']":"text-[12px] md:text-[22px] lg:text-[40px] font-medium font-['Moul']  leading-[22px] md:leading-[70px]"}}
                            ">
                               @lang('message.WTBOP')
                            </h1>
                        ...
                        <div data-aos="fade-left" class="w-full xl:max-w-[450px] bg-black h-full p-3 xl:p-8 2xl:p-10">
                            <form action="{{ route('send.mail') }}" method="POST">
                                ...
                                <div class="flex flex-col gap-2 md:gap-5">
                                    ...
                                    <button type="submit" class="text-[14px] w-[150px] text-gray-800 bg-gray-100 p-2">@lang('message.submit')</button>
                                </div>
                            </form>
                        </div>
                    </div>
