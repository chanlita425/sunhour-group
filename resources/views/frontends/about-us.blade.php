                ...
                <div class="w-full max-w-screen-xl mx-auto px-3 md:px-5 py-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 justify-center gap-6">
                        <div class="bg-black/20 p-6 md:p-8 rounded-sm w-full">
                            <p
                                class="mb-4 text-white text-[16px] md:text-[24px] font-light whitespace-pre-line {{ session()->get('locale') === 'en' ? "font-['Inter']" : "font-['Siemreap']" }}">
                                @lang('message.title_aboutus_2')
                            </p>
                            <p
                                class="text-white text-[11px] md:text-[14px] 2xl:text-[16px] font-light text-pretty whitespace-pre-line {{ session()->get('locale') === 'en' ? "font-['Inter']" : "font-['Siemreap']" }}">
